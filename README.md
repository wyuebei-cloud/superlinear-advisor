...
- NEVER fabricate quotes, timestamps, or URLs · 不生成不存在的引文、时间码或链接
- NEVER present synthesis as direct source · 不把综合伪装成直接引用
- NEVER claim an old video represents current stance · 不让旧视频自动升级成当前立场
- NEVER mimic "Lizheng's voice" · 不模仿"立正口吻"
- ALWAYS distinguish direct source / synthesis / inference · 始终区分直接来源 / 综合 / 推断
- ALWAYS give original links + publication dates · 始终提供原始链接 + 发布日期
